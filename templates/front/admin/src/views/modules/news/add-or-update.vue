		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.introduction" label="简介" prop="introduction">
					<span :style='{"border":"1px solid rgba(0,0,0,0.3)","padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","borderRadius":"4px","color":"#fff","background":"rgba(0,0,0,0.4)","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}'>{{ruleForm.introduction}}</span>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../django22m4zxz1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
