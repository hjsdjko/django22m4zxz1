	...
	<div class="addEdit-block" :style='{"width":"calc(100vw - 270px)","padding":"30px","margin":"0 0 0 210px","background":"rgba(0,0,0,0.5)"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出生日期" prop="chushengriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chushengriqi" label="出生日期" prop="chushengriqi">
					<el-input v-model="ruleForm.chushengriqi" placeholder="出生日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="专业代码" prop="zhuanyedaima">
					<el-input v-model="ruleForm.zhuanyedaima" placeholder="专业代码" clearable  :readonly="ro.zhuanyedaima"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="专业代码" prop="zhuanyedaima">
					<el-input v-model="ruleForm.zhuanyedaima" placeholder="专业代码" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="生源地" prop="shengyuandi">
					<el-input v-model="ruleForm.shengyuandi" placeholder="生源地" clearable  :readonly="ro.shengyuandi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="生源地" prop="shengyuandi">
					<el-input v-model="ruleForm.shengyuandi" placeholder="生源地" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="就业去向" prop="jiuyequxiang">
					<el-input v-model="ruleForm.jiuyequxiang" placeholder="就业去向" clearable  :readonly="ro.jiuyequxiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="就业去向" prop="jiuyequxiang">
					<el-input v-model="ruleForm.jiuyequxiang" placeholder="就业去向" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="单位名称" prop="danweimingcheng">
					<el-input v-model="ruleForm.danweimingcheng" placeholder="单位名称" clearable  :readonly="ro.danweimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="单位名称" prop="danweimingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="行业" prop="xingye">
					<el-input v-model="ruleForm.xingye" placeholder="行业" clearable  :readonly="ro.xingye"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="行业" prop="xingye">
					<el-input v-model="ruleForm.xingye" placeholder="行业" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="职业" prop="zhiye">
					<el-input v-model="ruleForm.zhiye" placeholder="职业" clearable  :readonly="ro.zhiye"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="职业" prop="zhiye">
					<el-input v-model="ruleForm.zhiye" placeholder="职业" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="升学状态" prop="shengxuezhuangtai">
					<el-select :disabled="ro.shengxuezhuangtai" v-model="ruleForm.shengxuezhuangtai" placeholder="请选择升学状态" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="升学状态" prop="shengxuezhuangtai">
					<el-input v-model="ruleForm.shengxuezhuangtai"
						placeholder="升学状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.jianliwenjian" label="简历文件" prop="jianliwenjian">
					<file-upload
						tip="点击上传简历文件"
						action="file/upload"
						:limit="1"
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `gerenxinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.gerenxinxiCrossAddOrUpdateFlag = false;
											this.parent.search();
