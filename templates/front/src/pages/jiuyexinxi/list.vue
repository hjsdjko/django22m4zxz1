...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"20px 0","alignItems":"center","flexWrap":"wrap","background":"#FFC054","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>就业单位：</div>
        <el-input v-model="formSearch.jiuyedanwei" placeholder="就业单位" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="btnAuth('jiuyexinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#000","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/jiuyexinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"margin":"0 0 10px","minWidth":"calc(100% - 200px)","background":"#fff","flex":"1","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 10px","background":"#fff","height":"auto"}'>
			<div :style='{"boxShadow":"0px 4px 5px 0px rgba(0,0,0,0.3)","padding":"10px","margin":"10px 1%","background":"#fff","display":"inline-block","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#333"}' class="name ">{{item.dengjibianhao}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#333"}' class="name ">{{item.xingming}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#333"}' class="name ">{{item.jiuyedanwei}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#333"}' class="name ">登记时间:{{item.dengjishijian}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.jiuyedanwei != '') searchWhere.jiuyedanwei = '%' + this.formSearch.jiuyedanwei + '%';
